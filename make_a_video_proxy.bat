...
FOR /F "usebackq delims==" %%i IN (`dir /B /A-D /OS`) DO move "%%i" "progress" && ffmpeg -y -i "progress\%%i" -b:v 256k -maxrate 512k -s 426x240 -r 25 -c:v h264_nvenc -pix_fmt yuv420p "ready\%%~ni_240p.mp4" &&  move "progress\%%i" "source"  
